...
\begin{frame}{\LARGE{Interessiert?}}
    \LARGE
    \textbf{Serlo allgemein:}\hfill \textbf{WikiBooks Export / Dresden:}\\
    \url{de@serlo.org}\hfill\url{serlo@vroland.de}\\
    \hfill\url{richard@agdsn.me}\\
    \vfill
    \textbf{Sprecht uns an:} AGDSN Assembly, DECT \url{8193}, \url{6923}
\end{frame}
