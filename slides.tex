...
\begin{frame}{}
    \centering
    \includegraphics[width=.65\linewidth, angle=90]{book_graph.pdf}
\end{frame}

\begin{frame}{}
    \centering
    \includegraphics[width=\linewidth]{toolchain.eps}
\end{frame}

\begin{frame}{}
    \centering
    \includegraphics[width=\linewidth]{toolchain_future.eps}
\end{frame}
